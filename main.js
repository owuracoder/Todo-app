    ...
    showProjectInTheDom(todoList){
        ...
        if(todoList.length > 0){
            ...
            <div class="todo-date show-date-icon">
                <h3>${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__.default)(new Date(todo.date), 'MMM do')}</h3>
            </div>`
            })
